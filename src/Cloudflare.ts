...
export class Pricing extends Schema.Class<Pricing>("cf-domain-search/Pricing")({
  currency: Schema.optionalKey(Schema.String),
  registration_cost: Schema.optionalKey(Money),
  renewal_cost: Schema.optionalKey(Money)
}) {}

export class CheckedDomain extends Schema.Class<CheckedDomain>("cf-domain-search/CheckedDomain")({
  name: Schema.String,
...
export class Account extends Schema.Class<Account>("cf-domain-search/Account")({
  id: Schema.String,
  name: Schema.String
}) {}
